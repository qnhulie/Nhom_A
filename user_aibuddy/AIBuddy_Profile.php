    ...
    <header>
        <div class="container header-content">
            ...
            <?php if (isset($_SESSION['userid']) && isset($user)): ?>
                <div class="user-greeting-badge">How's your day,
                    <strong><?= htmlspecialchars($user['UserName']) ?></strong>?</div>
            <?php else: ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="field-row">
                                    ...
                                    <button type="button" class="edit-btn"
                                        onclick="openEditModal('UserName','Full Name','<?= htmlspecialchars($user['UserName']) ?>')">Edit</button>
                                </div>
                            </div>
                            <div class="form-group">
                                <label>Email *</label>
                                <div class="field-row">
                                    <input type="email" value="<?= htmlspecialchars($user['UserEmail']) ?>"
                                        class="form-control" disabled>
                                    <button type="button" class="edit-btn"
                                        onclick="openEditModal('UserEmail','Email','<?= htmlspecialchars($user['UserEmail']) ?>')">Edit</button>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="field-row">
                                    <input type="text" value="<?= htmlspecialchars($user['PhoneNumber']) ?>"
                                        class="form-control" disabled>
                                    <button type="button" class="edit-btn"
                                        onclick="openEditModal('PhoneNumber','Phone Number','<?= htmlspecialchars($user['PhoneNumber']) ?>')">Edit</button>
                                </div>
                            </div>
                            <hr>
                            <br>
                            <p><strong>Membership Status:</strong> <span
                                    class="status active"><?= $membershipStatus ?></span></p>
                        </div>
                    <?php endif; ?>
                    ...
                    <?php if ($tab === 'subscription'): ?>
                        ...
                        if (!$currentPlan || $currentPlan['OrderStatus'] === 'Cancelled'):
                            ...
                            <div style="text-align: center; padding: 30px;">
                                ...
                                <p style="color: #777;">You currently don't have any active plan. Subscribe to unlock premium
                                    features.</p>
                                <a href="AIBuddy_Trial.php" class="btn-primary"
                                    style="display:inline-block; margin-top:15px; padding: 10px 20px; text-decoration:none;">Browse
                                    Plans</a>
                            </div>
                        <?php else: ?>
                            <div class="account-form">
                                ...
                                <div class="form-group">
                                    <label>Status</label>
                                    <input class="form-control" value="<?= $currentPlan['OrderStatus'] ?>" disabled
                                        style="color: green; font-weight: bold;">
                                </div>

                                <div style="display:flex; gap:15px; margin-top:25px;">
                                    <button class="edit-btn" style="background-color: #e74c3c;"
                                        onclick="openCancelModal()">Cancel Subscription</button>
        ...
        <div class="modal-box">
            ...
            <form method="post">
                ...
                <div class="form-group">
                    ...
                    <textarea name="refund_details" class="form-control" rows="4"
